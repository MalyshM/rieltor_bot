...
DATABASE_URL = "postgresql+asyncpg://postgres:admin@localhost/rieltor_bot"
...
class Admins(Base):
    ...
    date_of_add = mapped_column(DateTime, nullable=False)
...
class Selection(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['admin_id'], ['admins.id'], ondelete='CASCADE', name='selection_admin_id_fkey'),
...
class Users(Base):
    __tablename__ = 'users'
    __table_args__ = (
        ForeignKeyConstraint(['admin_id'], ['admins.id'], ondelete='CASCADE', name='users_admin_id_fkey'),
...
class BuyRequest(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='buy_request_user_id_fkey'),
...
class SellRequest(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='sell_request_user_id_fkey'),
...
class UsersConlultation(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='users_conlultation_user_id_fkey'),
...
class UsersMortgage(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='users_mortgage_user_id_fkey'),
...
class UsersQuestions(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE', name='users_questions_user_id_fkey'),
